...
const Business = () => {
  ...
  return (
    <div>
      <Helmet>
        <title>Business - NewsNacter</title>
        <meta
          name="description"
          content="Stay updated with the latest in business news, financial trends, and market analysis. Explore insights on inverstments, corporate developments, economic policies, and industry innovations. Join us for comperhensive coverage that empowers your business decisions."
        />
      ...
      <h1 className="text-center my-5 text-2xl font-medium">Business</h1>
