...
const Science = () => {
    ...
    const fetchEducation = async () => {
      try {
        const response = await fetch(
          `${backend_url}/news/getnews?category=science&limit=10000`
        );
  ...
  return (
    <div>
      <Helmet>
        <title>Science - NewsNacter</title>
        <meta
          name="description"
          content="Latest science news, discoveries, and research updates."
        />
      ...
      <h1 className="text-center my-5 text-2xl font-medium">Science</h1>
