...
const Education = () => {
    ...
    const fetchEducation = async () => {
      try {
        const response = await fetch(
          `${backend_url}/news/getnews?category=education&limit=10000`
        );
  ...
  return (
    <div>
      <Helmet>
        <title>Education - NewsNacter</title>
        <meta
          name="description"
          content="Latest education news, updates on admissions, exams, and policies."
        />
      ...
      <h1 className="text-center my-5 text-2xl font-medium">Education</h1>
